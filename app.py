...
def get_ai_response(messages_history):
    ...
    system_msg = {
        ...
        "content": (
            ...
            "1. Be friendly, conversational, and helpful like Gemini. Use natural Sinhala Unicode. "
...
st.markdown("""
    ...
    .stButton button { padding: 2px 10px !important; font-size: 12px !important; border-radius: 10px !important; }
    </style>
